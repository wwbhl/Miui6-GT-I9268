...
.field private static sInstances:[Lcom/android/internal/telephony/cat/CommandParamsFactory;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->sInstances:[Lcom/android/internal/telephony/cat/CommandParamsFactory;
...
.method static declared-synchronized getInstance(Lcom/android/internal/telephony/cat/RilMessageDecoder;Lcom/android/internal/telephony/uicc/IccFileHandler;)Lcom/android/internal/telephony/cat/CommandParamsFactory;
    ...
    :try_start_0
    sget-object v0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->sInstances:[Lcom/android/internal/telephony/cat/CommandParamsFactory;
    ...
    new-instance v3, Lcom/android/internal/telephony/cat/CommandParamsFactory;

    invoke-direct {v3, p0, p1}, Lcom/android/internal/telephony/cat/CommandParamsFactory;-><init>(Lcom/android/internal/telephony/cat/RilMessageDecoder;Lcom/android/internal/telephony/uicc/IccFileHandler;)V
...
.method private processRefresh(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 1077
    const-string v6, "process Refresh"
    ...
    const-string v7, "process Refresh ctlv numFiles"
...
.method private processSendSS(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 1124
    const-string v8, "process SendSS"
    ...
    const-string v9, "process SendSS nNumberByteCount="
    ...
    const-string v9, "processSendSS() nNumber="
    ...
    .line 1155
    :cond_2
    const-string v8, "processSendSS ss tag error"
...
.method private processSetupCall(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    const-string v10, "processSetupCall() ctlv.getRawValue().length="
    ...
    const-string v10, "processSetupCall() ctlv.getValueIndex()="
    ...
    const-string v10, "processSetupCall() nPhoneNumberByteCount="
    ...
    const-string v10, "processSetupCall() phone number="
    ...
    :cond_6
    const-string v9, "processSetupCall address tag error"
...
.method public dispose()V
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/cat/IconLoader;->dispose()V

    .line 1178
    iput-object v2, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mIconLoader:Lcom/android/internal/telephony/cat/IconLoader;
    ...
    .line 1181
    sget-object v1, Lcom/android/internal/telephony/cat/CommandParamsFactory;->sInstances:[Lcom/android/internal/telephony/cat/CommandParamsFactory;
